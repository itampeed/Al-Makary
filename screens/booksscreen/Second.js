    ...
    >
      <ScrollView style={styles.content} showsVerticalScrollIndicator={true}>
        <View style={styles.titleContainer}>
          <Text style={styles.title}>السِّلسلة الثَّانية</Text>
          <Text style={styles.subtitle}>مقدِّمات في طقوس الكنيسة</Text>
        </View>

        {/* TODO: Replace with actual book content */}
        <View style={styles.body}>
          <Text style={styles.paragraph}>محتوى السلسلة الثانية...</Text>
        </View>
